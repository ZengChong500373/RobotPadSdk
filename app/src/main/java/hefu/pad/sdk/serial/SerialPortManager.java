package hefu.pad.sdk.serial;

import android.os.HandlerThread;
import android.serialport.SerialPort;
import android.util.Log;

import hefu.pad.sdk.serial.message.LogManager;
import hefu.pad.sdk.serial.message.SendMessage;
...
//        LogPlus.i("发送命令：" + command);
    ...
    public void sendCmdDirection(final String command) {

        // TODO: 2018/3/22

        byte[] remoteControlByte = ByteUtil.stringToByte(command + " \\", "utf-8");
        rxSendData(remoteControlByte).subscribeOn(mSendScheduler).subscribe(new Observer<Object>() {
            @Override
            public void onSubscribe(Disposable d) {
