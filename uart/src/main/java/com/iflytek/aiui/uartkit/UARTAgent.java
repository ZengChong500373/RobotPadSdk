...
public class UARTAgent {
    private static final String TAG = "UARTAgent";
     ...
     * 创建UARTAgent
     *
     * @param device   串口设备名(需要设备可读写，如可以通过chmod 777 /dev/ttyS2)
     * @param speed    串口速率
     * @param listener 串口事件监听器
    ...
    private UARTAgent(final String device, final int speed, EventListener listener) {
            ...
            public void onSuccess() {
                ...
                handShake(new ActionListener() {
                    ...
                    public void onFailed(int errorCode) {
                        ...
                        Log.e(TAG, "AIUI失败，重启0");
                        mUARTManager.init(device, speed, null);
                    }
                });
            }
